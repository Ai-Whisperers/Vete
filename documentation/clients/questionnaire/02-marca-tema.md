# 2. Marca y Tema Visual

**[REQUERIDO]** - Defina la identidad visual de su sitio web.
...
[ ] Sí, tengo códigos hexadecimales exactos
[ ] Sí, pero no sé los códigos (adjuntaré logo/materiales)
...
[ ] **Profesional y Corporativo** - Serio, confiable, azules/grises
[ ] **Cálido y Acogedor** - Amigable, colores tierra, imágenes emotivas
[ ] **Vibrante y Juvenil** - Colores vivos, dinámico, divertido
[ ] **Elegante y Premium** - Sofisticado, oscuros, detalles dorados
...
[ ] Isotipo solo (símbolo sin texto)
[ ] Logo horizontal
...
[ ] Señalética de la clínica
[ ] Materiales impresos (folletos, recetas)
[ ] Publicaciones de redes sociales

> Adjunte fotos o archivos de estos materiales para mantener coherencia visual.
...
**Anterior:** [01-informacion-basica.md](./01-informacion-basica.md)
**Siguiente:** [03-pagina-principal.md](./03-pagina-principal.md)
