...
const connectionString = 'postgresql://postgres:VetePlatform2024!@db.okddppczckbjdotrxiev.supabase.co:5432/postgres';
...
async function executeSeed() {
  ...
  try {
    ...
    const sqlContent = fs.readFileSync('web/db/seeds/generated-seed.sql', 'utf8');
