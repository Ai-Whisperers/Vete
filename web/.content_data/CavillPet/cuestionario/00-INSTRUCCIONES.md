...
Estimado cliente, complete cada sección marcando las opciones que correspondan a su clínica veterinaria. Para cada pregunta:

1. **Marque con [X]** las opciones que apliquen
2. **Complete los campos** donde se solicite información específica
3. **Agregue notas adicionales** en la sección de comentarios si es necesario
