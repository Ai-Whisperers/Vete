  ...
  if (!profile || !['vet', 'admin'].includes(profile.role)) {
      return (
        <div className="p-8 text-center">
            ...
            <Link href={`/${clinic}/portal/dashboard`} className="text-blue-500 hover:underline mt-4 block">Volver al Inicio</Link>
        </div>
      )
  }
    ...
    <div className="max-w-4xl mx-auto space-y-8">
        <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-3xl font-black font-heading text-[var(--text-primary)]">Agenda Veterinaria</h1>
