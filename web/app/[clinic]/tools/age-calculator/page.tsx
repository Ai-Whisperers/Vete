...
export async function generateMetadata({ params }: { params: Promise<{ clinic: string }> }): Promise<Metadata> {
  ...
  const description = 'Convierte la edad de tu perro o gato a años humanos con nuestra calculadora científica. Basada en estudios reales, no en el mito de los 7 años.';
