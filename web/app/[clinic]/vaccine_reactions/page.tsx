...
export const generateMetadata = async () => ({
  ...
  description: 'Registro y monitoreo de reacciones adversas post-vacunación en pacientes veterinarios.',
  openGraph: { title: 'Reacciones a Vacunas', description: 'Sistema de farmacovigilancia veterinaria' },
