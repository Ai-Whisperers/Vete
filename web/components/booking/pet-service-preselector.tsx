...
export function PetServicePreselector({
  ...
  useEffect(() => {
    ...
    } else if (initialPetId && petServiceHistory && petServiceHistory[initialPetId] && !selectedService) {
  ...
  }, [initialPetId, initialServiceId, petServiceHistory, onPetChange, onServiceChange, selectedPet, selectedService]);
