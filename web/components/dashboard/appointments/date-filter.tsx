    ...
    <div className="flex items-center gap-2">
      ...
      <div className="relative">
        <input
          ...
          className="px-4 py-2 pr-10 rounded-lg border border-gray-200 bg-white text-sm font-medium focus:border-[var(--primary)] focus:ring-2 focus:ring-[var(--primary)]/20 outline-none"
        />
      </div>
