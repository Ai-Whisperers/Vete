...
export default function PreAuthForm({ petId, policyId, onSuccess }: PreAuthFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!selectedPolicyId || !selectedPetId || !procedureDescription || !diagnosis || !estimatedCost || !clinicalJustification) {
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        ...
        <p className="mt-1 text-xs text-[var(--text-secondary)]">
          Incluya hallazgos clínicos, resultados de exámenes, y por qué el procedimiento es necesario.
        </p>
      </div>
