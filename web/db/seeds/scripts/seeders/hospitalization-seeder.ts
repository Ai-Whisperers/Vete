...
export class HospitalizationSeeder extends BaseSeeder<Hospitalization> {
  ...
  protected async preProcess(data: unknown[]): Promise<unknown[]> {
    ...
    const dbColumns = [
      'tenant_id', 'pet_id', 'kennel_id', 'admission_number',
      'admitted_at', 'expected_discharge', 'actual_discharge',
      'reason', 'diagnosis', 'notes', 'discharge_instructions',
      'status', 'acuity_level',
      'primary_vet_id', 'admitted_by', 'discharged_by',
    ];
