...
--
-- Dependencies: 40_services.sql, 20_pets/20_pets.sql
-- =============================================================================
...
CREATE TABLE IF NOT EXISTS public.appointments (
    ...
    CONSTRAINT appointments_not_past CHECK (
        created_at < start_time OR status != 'scheduled'
    )
);
