...
export function useForm(options: UseFormOptions = {}): UseFormResult {
  ...
  const setValue = useCallback((field: string, value: any) => {
    setFormState(prev => {
      const currentField = prev[field] || { value: undefined, error: null, touched: false, dirty: false };
      ...
      return {
        ...
        [field]: {
          ...
          value: newValue,
          dirty,
          error: validateOnChange && validationRules[field]
    ...
    setFormState(prev => {
      ...
      return {
        ...
        [field]: {
          ...currentField,
          touched,
          error: validateOnBlur && touched && validationRules[field]
