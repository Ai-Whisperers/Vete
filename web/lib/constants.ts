export const ERROR_MESSAGES = {
  ...
  APPOINTMENT_TOO_SOON: "La cita debe ser al menos 15 minutos en el futuro y no puede ser en el pasado.",
  ...
  PET_NOT_FOUND: "Mascota no encontrada. La mascota seleccionada no existe o fue eliminada. Selecciona otra mascota.",
  UNAUTHORIZED_PET_ACCESS: "No tienes permiso para agendar citas para esta mascota. Solo puedes agendar citas para tus propias mascotas.",
  ...
  GENERIC_APPOINTMENT_ERROR: "No se pudo agendar la cita. Por favor, intenta de nuevo en unos minutos.",
  LOGIN_REQUIRED: 'Debes iniciar sesión para agendar una cita. Por favor, inicia sesión y vuelve a intentarlo.',
