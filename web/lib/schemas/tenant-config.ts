 ...
 * 
 * Usage:
 *   import { configSchema, themeSchema } from '@/lib/schemas/tenant-config';
 ...
 */
export function validateConfig(data: unknown): TenantConfig {
  try {
 ...
 * @throws {ZodError} with detailed error messages if invalid
 */
export function validateTheme(data: unknown): TenantTheme {
  try {
 ...
 */
export function safeValidateConfig(data: unknown): { success: true; data: TenantConfig } | { success: false; errors: z.ZodError } {
 ...
 */
export function safeValidateTheme(data: unknown): { success: true; data: TenantTheme } | { success: false; errors: z.ZodError } {
